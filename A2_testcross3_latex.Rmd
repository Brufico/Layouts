...
ref1 <- function(prefix, id, page = FALSE){
        refName <- paste(prefix, id, sep = ":")
        lcommand <- ifelse(page,"pageref","ref")
        paste0("\\", lcommand,"{", refName, "}")
}


refs <- function(prefix, id, withpage = FALSE, capital = FALSE){
        refName <- paste(prefix, id, sep = ":")
        ...
        main <- paste(typeref, ref1(prefix, id, page = FALSE), sep = " ")
        result <- if (withpage) {
                paste(main , ", page", ref1(prefix, id, page = TRUE))
        } else {main}
}                         
