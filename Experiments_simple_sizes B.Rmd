...
tabcap <- function(caption, chunklabel=knitr::opts_current$get("label")) {
        paste0("\\label{tab:", chunklabel, "}", caption)
}
# Table captions ??
...
* Table references a la Latex (création des refs avec tabcap, appel avec `\ref{...)`
    * refer to table [The "Summary table"], ie table \ref{tab:cars}
